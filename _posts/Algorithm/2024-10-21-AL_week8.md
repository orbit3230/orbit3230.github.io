...
- 방법
  ...
  ![huffman_priority_queue_1](TODO)  
  - (3) 묶음을 새로운 node로 만들어 합산한 frequence로 `PQ`에 넣는다.  
  ![huffman_priority_queue_2](TODO)
  ![huffman_priority_queue_3](TODO)
  ![huffman_priority_queue_4](TODO)  
  - (4) 이 과정을 반복한다.  
  ![huffman_priority_queue_5](TODO)
  - (5) huffman tree 완성  
  ![huffman_tree_complete](TODO)  
