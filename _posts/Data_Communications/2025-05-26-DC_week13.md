...
![Scenario 2 - Perfect knowledge](TODO)  
  - Sender는 오직 라우터 버퍼가 available 할 때만 전송한다.  
  ![Scenario 2 - Perfect knowledge](TODO)  

- Idealization : **some** perfect knowledge  
![Scenario 2 - Some perfect knowledge](TODO)  
  - 패킷은 가득 찬 버퍼에 의해 lost될 수 있다.
  - Sender는 패킷이 dropped 되었을 때, 이를 알 수 있다. : 패킷이 lost 되었다면 재전송 한다.  
  ![Scenario 2 - Some perfect knowledge](TODO)  

- Realistic scenario : **un-needed duplicates**  
![Scenario 2 - Un-needed duplicates](TODO)
  - 패킷은 가득 찬 버퍼에 의해 lost될 수 있다.  
  -> 이는 재전송을 요구한다.
  - 그러나 sender timer는 prematurely time-out되어, 두 개의 복사본이 전달될 수 있다.  
  ![Scenario 2 - Un-needed duplicates](TODO)
...
![Scenario 3 - Another cost of congestion](TODO)  
...
![End-to-end congestion control](TODO)  
...
![Network-assisted congestion control](TODO)  
