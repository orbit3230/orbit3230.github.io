...
![multiclass_classification_counts](TODO)  
...
![multiclass_classification_predict](TODO)  
...
![multiclass_classification_predict_proba](TODO)  

```py
print(model.coef_, model.intercept_)
```

![multiclass_classification_coef_intercept](TODO)  
...
![knn_classification_predict](TODO)  
...
![knn_classification_evaluation](TODO)  
...
![knn_classification_k_value](TODO)  
...
![knn_classification_k_value_plot](TODO)
...
![naive_bayes_dataset](TODO)  

  - 우리가 예측하고자 하는 것이 `Sunny ∩ High` 일 때 `Tennis`의 값이라면,  
  
    - (1) evidence `P(X)`  
    ![naive_bayes_evidence](TODO)  

    - (2) likelihood `P(X|Y)`  
    ![naive_bayes_likelihood](TODO)  

    - (3) prior probability `P(Y)`  
    ![naive_bayes_prior](TODO)  

    - (4) posterior probability `P(Y|X)`  
    ![naive_bayes_posterior](TODO)  
...
![naive_bayes_classification_head](TODO)  
...
![naive_bayes_classification_predict](TODO)  
...
![naive_bayes_classification_evaluation](TODO)  
