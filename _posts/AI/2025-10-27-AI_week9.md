...
![tabular_methods_as_function_approximation](TODO)  
...
![optimization_of_objective_functions](TODO)  

<br>

- Gradient Descent  
![gradient_descent](TODO)  
  - 기계 학습 분야를 포함하여 대량의 데이터에 대한 최적화 문제에서 활용되는 방법  
  - 반복적인 매개변수 업데이트를 통해 최적의 매개변수를 학습  
  - Steps  
  ![gradient_descent_steps](TODO)  
...
- 어떻게 Gradient Descent가 작동하는가?
  ...
  ![taylor_series_objective_function](TODO)  
  ![taylor_series_objective_function_expanded](TODO)  

<br>

- Convexity & Convergence  
![convexity_convergence](TODO)  
  ...
  ![convex_function_convergence](TODO)  
...
- Update Rule
  - Squared Error
    ...
    ![svf_approximation_update_rule](TODO)  

    - Action-Value Function Approximation  
    ![avf_approximation_update_rule](TODO)

  - Huber Loss  
    - State-Value Function Approximation  
    ![svf_approximation_update_rule_huber](TODO)  

    - Action-Value Function Approximation  
    ![avf_approximation_update_rule_huber](TODO)  

<br>

- True Gradient Descent  
![true_gradient_descent](TODO)  
...
![on_policy_mc_control_function_approximation_pseudocode](TODO)  

- Pseudocode: Sarsa  
![sarsa_function_approximation_pseudocode](TODO)  

- Pseudocode: n-step Sarsa  
![n_step_sarsa_function_approximation_pseudocode](TODO)  

<br>

### 2. Linear Function Approximation  
- 다항 함수(Polynomial Function)  
![polynomial_function](TODO)  
...
- 다항 함수 = 선형 함수(Linear Function)  
  ...
  ![linear_function](TODO)  

  - m차원 입력에 대한 선형 함수의 일반적인 형태  
  ![general_linear_function](TODO)  

  - 열 벡터 표현식  
  ![linear_function_vector_form](TODO)  

- Linear Function Approximation  
  - m차원 상태의 가중 입력합으로 가치 함수를 표현  
  ![linear_function_approximation](TODO)  
...
- Feature Vector: Polynomials  
  ...
  ![polynomial_feature_vector](TODO)  
  - e.g., 2차원 상태 벡터 -> 8차원 특성 벡터

- Feature Vector: Coarse Coding  
![coarse_coding_feature_vector](TODO)  
...
- Feature Vector: Tile Coding
  ...
  - e.g.,  
  ![tile_coding_feature_vector](TODO)  

<br>

- Gradient Descent  
![linear_function_approximation_gradient_descent](TODO)  

<br>

- Action-Value: One-Hot Encoding  
![avf_one_hot_encoding](TODO)  
...
- Action-Value: Seperated FA  
![avf_seperated_fa](TODO)  
  - 각 행동마다 별도의 매개변수를 활용  
  - e.g., 행동 `a` ∈ `{0, 1, 2, 3}`  
  ![avf_seperated_fa_equation](TODO)  
