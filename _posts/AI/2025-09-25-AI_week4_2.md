...
- Behavior Policy to Target Policy
  ...
  ![behavior_to_target_policy](TODO)  
  - Target Policy `π`에 대한 가치 함수는?  
  ![target_policy_value_function](TODO)  
  ...
  ![importance_sampling_1](TODO)  
  ![importance_sampling_2](TODO)  
  ![importance_sampling_3](TODO)  
  ![importance_sampling_4](TODO)  

- Importance Sampling: Monte Carlo Prediction  
  - Ordinary Importance Sampling Estimator  
  ![ordinary_importance_sampling_estimator](TODO)  
    -> 그러나 IS Ratio가 크다면, 가치 함수의 값 또한 크게 변동할 수 있음  
  - Weighted Importance Sampling Estimator  
  ![weighted_importance_sampling_estimator](TODO)  
...
- Importance Sampling: Incr. Impl.  
  ...
  ![importance_sampling_incr_imple_1](TODO)  
  ![importance_sampling_incr_imple_2](TODO)  

- Importance Sampling: Update Rule  
  - 상태 가치 함수  
  ![importance_sampling_update_rule_state_value_function](TODO)  
  - 행동 가치 함수  
  ![importance_sampling_update_rule_action_value_function](TODO)  
...
![flat_partial_return_vs_return](TODO)  

- Discounting-Aware Importance Sampling  
  - Ordinary Importance Sampling Estimator  
  ![discounting_aware_ordinary_importance_sampling_estimator](TODO)  
  - Weighted Importance Sampling Estimator  
  ![discounting_aware_weighted_importance_sampling_estimator](TODO)  

<br>

- Per-Decision Importance Sampling  
  - 기본적인 Importance Sampling에서는 각 시점의 보상에 대해서 종료 시점까지 고려한 IS Ratio가 곱해짐  
  ![basic_importance_sampling](TODO)  
    - 직관적으로 생각해보면 각 시점의 보상에 대해서는 해당 시점까지만 고려한 IS Ratio가 곱해져야 함  
  - Ordinary Importance Sampling Estimator  
  ![per_decision_ordinary_importance_sampling_estimator](TODO)  
  - Weighted Importance Sampling Estimator  
    - 명확히 제안된 바 없음  
