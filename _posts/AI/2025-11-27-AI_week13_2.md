...
- Rewrite Value Function with Entropy
  ...
  ![entropy_regularized_state_value_function][def54]  

  - Action-Value Function  
  ![entropy_regularized_action_value_function][def55]  

<br>

- Training Critic: Objective Function  
![entropy_regularized_critic_objective_function][def56]  

- Training Critic: Loss Gradient & Update Rule  
![entropy_regularized_critic_loss_gradient][def57]  

- Training Actor: Objective Function  
![entropy_regularized_actor_objective_function][def58]  

- Training Actor: Policy Gradient & Update Rule  
![entropy_regularized_actor_policy_gradient][def59]  

- Training Actor: Reparameterization Trick
  - 정규 분포  
  ![reparameterization_trick_normal][def60]  

  - 표준 정규 분포 (`μ`=`0`, `σ`=`1`)  
  ![reparameterization_trick_standard_normal][def61]  

  - 정규 분포의 확률 변수 `a`와 표준 정규 분포의 확률 변수 `z`의 관계  
  ![reparameterization_trick_relationship][def62]  

  - 가능한 모든 행동의 확률을 고려하는 대신, 행동은 이미 선택되었고 그의 확률 분포는 표준 정규 분포를 따르도록 변경  
  ![reparameterization_trick_application][def63]  
    - 더 이상 정책의 확률 분포에 의존적이지 않음  

- Training Actor: Updated Policy Gradient & Update Rule  
![entropy_regularized_actor_reparameterization_trick_1][def64]  
![entropy_regularized_actor_reparameterization_trick_2][def65]  

<br>

- Soft Actor-Critic : Entropy Regularization + Experience Replay + Fixed Target Network + Clipped Double Q-Learning  
  - Critic Update  
  ![soft_actor_critic_critic_update][def66]  

  - Actor Update  
  ![soft_actor_critic_actor_update][def67]

  - Target Network  
  ![soft_actor_critic_target_network][def68]  
...
- Relative Improvements of New Policy  
  ...
  ![trust_region_relative_improvements_1][def69]  
  ![trust_region_relative_improvements_2][def70]  
  ![trust_region_relative_improvements_3][def71]  
  ![trust_region_relative_improvements_4][def72]  
  ![trust_region_relative_improvements_5][def73]  
...
- TRPO: Taylor Series  
![trpo_taylor_series_1][def78]  

- TRPO: Taylor Series of Relative Improvements  
![trpo_taylor_series_relative_improvements][def79]  

- TRPO: Taylor Series of Constraint  
![trpo_taylor_series_constraint][def80]  

<br>

- TRPO: Lagrange Multiplier
  - 제약사항이 있는 최적화 문제를 푸는 방법  
  ![trpo_lagrange_multiplier_1][def81]  
    - 목적 함수와 제약 사항을 하나의 식으로 통합  
    ![trpo_lagrange_multiplier_2][def82]  
    - 최적의 `x`와 `λ`를 찾는 문제(Dual Form)로 변경 (단, `f(x)`, `g(x)`는 볼록 함수)  
    ![trpo_lagrange_multiplier_3][def83]  

<br>

- TRPO: Update Rule  
![trpo_update_rule][def84]  
...
[def50]: https://i.imgur.com/4luLBh8.png
[def51]: https://i.imgur.com/pW1jm7u.png
[def52]: https://i.imgur.com/6uz2sF0.png
[def53]: https://i.imgur.com/noJLE53.png
[def54]: https://i.imgur.com/efmLL8U.png
[def55]: https://i.imgur.com/raxfcdB.png
[def56]: https://i.imgur.com/Z530ixA.png
[def57]: https://i.imgur.com/BmH5HL7.png
[def58]: https://i.imgur.com/ijk6haf.png
[def59]: https://i.imgur.com/PAhvFGt.png
[def60]: https://i.imgur.com/CX87EoD.png
[def61]: https://i.imgur.com/050J6aV.png
[def62]: https://i.imgur.com/p1znIX3.png
[def63]: https://i.imgur.com/7gYvIpo.png
[def64]: https://i.imgur.com/VZI56V4.png
[def65]: https://i.imgur.com/TM9G523.png
[def66]: https://i.imgur.com/flGLiS2.png
[def67]: https://i.imgur.com/lbMj3wE.png
[def68]: https://i.imgur.com/7YKHZGz.png
[def69]: https://i.imgur.com/FH7dK2a.png
[def70]: https://i.imgur.com/0hJmYsK.png
[def71]: https://i.imgur.com/5AhLP77.png
[def72]: https://i.imgur.com/4ZGjOsP.png
[def73]: https://i.imgur.com/8Spm2Lt.png
[def74]: https://i.imgur.com/Ud7zUCZ.png
[def75]: https://i.imgur.com/TEaF1U2.png
[def76]: https://i.imgur.com/mnfz0BX.png
[def77]: https://i.imgur.com/P3V1UCU.png
[def78]: https://i.imgur.com/wBWNaiI.png
[def79]: https://i.imgur.com/TIpysJ1.png
[def80]: https://i.imgur.com/1BivobM.png
[def81]: https://i.imgur.com/v8vRUaA.png
[def82]: https://i.imgur.com/mPNYkDQ.png
[def83]: https://i.imgur.com/4ChOrqS.png
[def84]: https://i.imgur.com/HN5rPYS.png