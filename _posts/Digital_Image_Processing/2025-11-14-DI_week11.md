...
### 6. 동영상 압축
- 공간 여분(Spatial Redundancy) : 이웃하는 화소들끼리 값이 비슷한 현상
- 시간 여분(Temporal Redundancy) : 연속된 프레임의 대응하는 픽셀들끼리 비슷한 현상
- 공간 여분과 시간 여분을 최대한 이용하여 압축  
![video_compression_example_1][def23]  
![video_compression_example_2][def24]  

<br>

- ★ 동영상 압축 예제  
![video_compression_example_make_function][def25]    
  - DCT  
  ![video_compression_example_dct][def26]  

  - Quantization  
  ![video_compression_example_quantization][def27]  

  - Inverse Quantization  
  ![video_compression_example_inverse_quantization][def28]  

  - Inverse DCT  
  ![video_compression_example_inverse_dct][def29]  

- Motion Estimation  
![video_compression_example_motion_estimation_1][def30]  
![video_compression_example_motion_estimation_2][def31]  

  - Quantization & DCT  
  ![video_compression_example_quantization_dct][def32]  

  - Motion Compensation  
  ![video_compression_example_motion_compensation][def33]  

- 입력과 결과 (연습용)  
![video_compression_example_input_output][def34]  
...
[def23]: https://i.imgur.com/mIqYqv5.png
[def24]: https://i.imgur.com/NjKCYNd.png
[def25]: https://i.imgur.com/2aknUG3.png
[def26]: https://i.imgur.com/BPyLi77.png
[def27]: https://i.imgur.com/TOxZOZE.png
[def28]: https://i.imgur.com/Imc7fGz.png
[def29]: https://i.imgur.com/K8i9rQf.png
[def30]: https://i.imgur.com/wMCLY5b.png
[def31]: https://i.imgur.com/sksPTke.png
[def32]: https://i.imgur.com/32njRiR.png
[def33]: https://i.imgur.com/oc4lA6w.png
[def34]: https://i.imgur.com/nJLv3px.png