...
![8_bit_floating_point_example](TODO)
...
![6_bit_floating_point_example](TODO)
...
![6_bit_floating_point_visualization](TODO)  
  - 좀 더 `0`부분을 확대해서 보자.  
  ![6_bit_floating_point_visualization_close_up](TODO)  
...
- Unsigned Integer Comparison을 (거의) 사용 가능하다.  
  - 반드시 sign bits를 먼저 비교해야 한다.
  - `-0` = `0` 임을 고려해야 한다.
  - NaNs 는 문제가 될 수 있다.
    - 다른 어떠한 수보다 다루기 곤란하다..
    - 비교 기준을 어떻게 잡아야함? (TODO)
  - 그 외 경우는 OK.
