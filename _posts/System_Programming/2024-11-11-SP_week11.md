...
![nonexecutable_code_segments](TODO)  
...
- disassemble 해보면,  
![stack_canaries_disassemble](TODO)  

- Checking Canary  
![stack_canaries_checking_1](TODO)  
![stack_canaries_checking_2](TODO)  
...
- ARM MTE(Memory Tagging Extension)  
  ...
  - Tag들을 새로운 HW instruction을 사용하여 만들어진다.  
...
- 해커들이 직면한 새로운 문제
  ...
  - stack을 non-executable로 만든 것이 binary code를ㄹ 삽입하기 어렵게 만들었다.  
...
![high_level_idea_of_rop](TODO)  

<br>

- Gadget Example  
![gadget_example_1](TODO)  
![gadget_example_2](TODO)  
