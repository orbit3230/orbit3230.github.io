...
- 첫 번째 코드는 spatial locality가 더 높다.  
...
### 2 Caches
- Cache : 더 작고 빠른 storage device로서, 더 크고 느린 storage device내 일부분으로 staging area의 역할을 한다.  
