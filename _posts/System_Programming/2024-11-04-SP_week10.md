...
- XMM Registers
  ...
  ![xmm_registers](https://i.imgur.com/zvBVO2G.png)  
...
- Scalar SIMD Operations  
  ...
  `addss %xmm0, %xmm1`  
  ![scalar_single](https://i.imgur.com/hHBshSB.png)  

  - SIMD Operations : Single Precision  
  `addps %xmm0, %xmm1`  
  ![simd](https://i.imgur.com/NgVm4lF.png)  

  - Scalar Operations : Double Precision  
  `addsd %xmm0, %xmm1`  
  ![scalar_double](https://i.imgur.com/R46tq3D.png)  
