...
![destination_based_forwarding](TODO) 
...
- Switching fabrics
  ...
  - Switching rate : 패킷이 input -> output으로 이동할 수 있는 속도
    ...
    ![switching_fabrics](TODO)  
  - 세 가지 주요 유형  
  ![switching_fabrics_types](TODO)  
    - (1) Memory  
    ![memory_switching](TODO)  
      - 패킷이 시스템 메모리에 복사
    ...
    ![interconnection_network_switching](TODO)  
      ...
      ![multiple_switching_planes](TODO)  
        - 병렬화를 통해 속도 향상
        - Cisco CRS router  
...
- Packet scheduling  
  - 다음으로 link에 보낼 패킷을 결정
    ...
    - Priority scheduling  
    ![priority_scheduling](TODO)  
      - 우선순위가 높은 패킷이 먼저 전송됨
      - 낮은 우선순위 패킷이 무한정 대기하는 현상 발생 가능 (starvation)
    - Round Robin  
    ![round_robin_scheduling](TODO)  
      - 각 큐에서 하나씩 패킷을 선택하여 전송
      - 큐의 길이가 다를 때, 긴 큐가 불리
    - Weighted fair queuing  
    ![weighted_fair_queuing](TODO)  
