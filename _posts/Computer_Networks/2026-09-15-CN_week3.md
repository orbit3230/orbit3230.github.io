...
![nat](TODO)  
  ...
  - 모든 디바이즈에 대해 provider ISP로부터 단 하나의 public IP 주소만 필요함
...
- Extension headers
  ...
  ![extension_headers](TODO)  

- IPv6 Addressing
  - 128-bit 주소
  - 8개의 네 자리수 16진수로 표현. No dotted decimal notation  
  ![ipv6_addressing](TODO)  

  - 축약 표현 규칙  
    - Rule 1. 모두 `0`인 그룹은 `::`로 표현 가능 (한 번만)  
    ![ipv6_reduction_example_1](TODO)  
    - Rule 2. 선행하는 `0`은 생략 가능  
    ![ipv6_reduction_example_2](TODO)  
    ![ipv6_reduction_example_combination](TODO)  
