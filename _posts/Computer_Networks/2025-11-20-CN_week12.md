...
![switch_multiple_simultaneous_transmissions](TODO)  
...
![switch_frame_filtering_forwarding](TODO)
  - 프레임이 스위치에서 수신되면,
  ...
  - example 1  
  ![switch_example_1](TODO)  

  - example 2  
  ![switch_example_2](TODO)  

<br>

- Interconnecting switches
  - Self-learning 스위치들은 서로 연결될 수 있다.  
  ![interconnecting_switches](TODO)  
    - `A`->`G`로 전송 - `S1`은 `S4`와 `S3`를 통해 `G`로 프레임을 포워딩할 수 있음을 어떻게 아는가?  
    -> self-learning !  

    - example  
    ![interconnecting_switches_example](TODO)  

<br>

- Small institutional network  
![small_institutional_network](TODO)  

<br>

- Switches vs. Routers  
![switches_vs_routers](TODO)  
...
![vlans_spanning_multiple_switches](TODO)  
...
![ieee_802_1q_vlan_frame_format](TODO)  
