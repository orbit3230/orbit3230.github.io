...
![network_management_components](TODO)  

<br>

- Network operator approaches to management  
![network_operator_approaches_to_management](TODO)  
...
- SNMP protocol
  - MIB info, commands를 전달하는 두 방식
    ...
    ![snmp_request_response_mode](TODO)  

    - trap mode  
    ![snmp_trap_mode](TODO)  

  - 메시지 타입  
  ![snmp_message_types](TODO)  

  - 메시지 포맷  
  ![snmp_message_format](TODO)  
...
![netconf_initialization_exchange_close](TODO)  

- Selected NETCONF operations  
![netconf_selected_operations](TODO)  

- Sample NETCONF RPC message  
![netconf_sample_rpc_message](TODO)  
