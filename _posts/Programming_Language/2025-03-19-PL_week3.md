...
- 판단문  
![arithmetic_expression_judgment](TODO)  

- 추론 규칙  
![arithmetic_expression_inference_rule](TODO)  

- 문법  
![arithmetic_expression_grammar](TODO)  

- 증명 예  
![arithmetic_expression_proof_tree](TODO)  
...
- 문법  
![propositional_logic_grammar](TODO)  

- 수학적 의미(Denotational Semantics) `[[ A ]]`  
![propositional_logic_denotational_semantics](TODO)

- 진리표 (Truth Table)  
![propositional_logic_truth_table](TODO)  

- `(T ∧ (T ∨ F)) => F`의 의미?  
![propositional_logic_example](TODO)  
