...
- 관계 대응수의 최솟값과 최댓값 ★
  ...
  ![min_max_cardinality](TODO)  
  ![min_max_cardinality_example](TODO)  

<br>

- ISA 관계 : 상위 개체 타입의 특성에 따라 개체 타입이 결정되는 형태 (ISA => is-a)  
![isa_relationship](TODO)  
![isa_relationship_example](TODO)  
...
- IE 표기법(Information Engineering Notation)
  ...
  - IE 표기법에서 개체 타입과 속성은 직사각형으로 표현  
    - ER 표기법 Example  
    ![er_notation_example](TODO)  
    - IE 표기법 Example  
    ![ie_notation_example](TODO)  

  - IE 표기법에서 관계는 실선 or 점선으로 표기  
  ![ie_relationship_representation](TODO)  

  - IE 표기법에서 관계(강한 관계, 비식별자 관계)는 점선으로 표기  
  ![ie_strong_relationship_representation](TODO)  

  - IE 표기법에서 관계(약한 관계, 식별자 관계)는 실선으로 표기  
  ![ie_weak_relationship_representation](TODO)  
