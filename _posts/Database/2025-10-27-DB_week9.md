...
![er_to_relational_mapping](TODO)  

<br>

- 개체 타입의 사상  
![entity_type_mapping](TODO)  
  - (1단계) 강한(정규) 개체 타입
...
- 이진 관계 타입  
![binary_relationship_type_mapping](TODO)  
...
- 관계 타입의 사상
  - (3단계) 이진 1:1 관계 타입  
  ![binary_1to1_relationship_type_mapping](TODO)  
    - 이진 1:1 관계 타입의 경우 [방법1] ~ [방법4]까지 모든 유형으로 매핑 가능
    - 개체가 가진 정보 유형에 따라 판단  

  - (4단계) 이진 1:N 관계 타입 ★  
  ![binary_1toN_relationship_type_mapping](TODO)  
    - 이진 1:N 관계 타입의 경우 N의 위치에 따라 [방법1] 또는 [방법2] 유형으로 매핑  

  - (5단계) 이진 M:N 관계 타입  
  ![binary_MtoN_relationship_type_mapping](TODO)  
    - 이진 M:N 관계 타입은 [방법4]의 유형으로 매핑

  - (6단계) N진 관계 타입  
  ![nary_relationship_type_mapping](TODO)  
    - ER 모델의 차수가 3 이상인 다진 관계 타입의 경우 [방법4]의 유형으로 매핑  

<br>

- 다중값 속성의 사상  
![multivalued_attribute_mapping](TODO)  
  - (7단계) 다중값 속성  
  ![multivalued_attribute_mapping_example](TODO)  
