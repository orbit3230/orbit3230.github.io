...
- Fitting term
  ...
  ![laplacian_editing_fitting_term](TODO)  

  - 3D에서는 주변 neighbor vertex들의 평균과의 차이로 Laplacian 값을 정의  
  ![laplacian_editing_laplacian_definition](TODO)  

- Distortion term
  - Deformation동안의 Laplacians에서의 변화를 최소화  
  ![laplacian_editing_distortion_term](TODO)  

<br>

- 따라서 다시 작성하면, Deformed locations `p'`<sub>`i`</sub>를 찾는 것은, 아래를 최소화하는 것  
![laplacian_editing_final_equation](TODO)  
