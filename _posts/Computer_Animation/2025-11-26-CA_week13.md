...
![volume_preservation_force](TODO)  

- Volume이 줄어든 양 만큼에 비례하게 노드를 위로 미는 힘을 가한다.  
![pressing_upwards_proportionally](TODO)  
...
- 3D 모션 캡쳐 데이터로부터 Blendshape animation 컨트롤을 학습할 수 있다.
  ...
  ![constrained_linear_system](TODO)  
