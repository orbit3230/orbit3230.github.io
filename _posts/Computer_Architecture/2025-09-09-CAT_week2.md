...
excerpt: "Components of a Computer, Inside a Computer (Past & Now), Eight Great Ideas, End of Moore's Law, Future Opportunities, Understanding Performance, Relative Performance, Measuring Execution Time, CPU Clocking"
...
- Example
  - 특정 Task를 수행하는 데 A 프로세서는 10초, B 프로세서는 15초가 걸린다.  
