...
- 한 Clock Cycle 내에서 어떤 일이 일어나는가 ?
  ...
  - 여기서 질문, 현재 cycle에 대한 control signal을 현재 cycle 내에서 생성하는건 왜 안되나 ?
    ...
    - 왜 ?
      - A Clock cycle  
      ![clock_cycle_good](TODO)
      - A Bad Clock cycle  
      ![clock_cycle_bad](TODO)  

<br>

### 6. A Simple Little Computer 3b
- An educational ISA  
![simple_little_computer_3b_isa](TODO)  
  - 16 bits instruction
  - `opcode [15:12]` : 16 different opcodes  

- Control & Datapath  
![simple_little_computer_3b_datapath](TODO)  
