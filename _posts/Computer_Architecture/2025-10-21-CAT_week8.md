...
excerpt: "Data Format, MIPS-32 ISA, MIPS Design Principles, MIPS Instructions, (Review+) Integers, Representing Instructions, Logical Operations, Review+: From Assembly to Machine Code"
...
- MIPS NOT Operations
  - bits invert에 유용
    - `0`은 `1`로, `1`은 `0`으로 변경
  - MIPS는 NOR 3-operand instruction을 제공
    - `a NOR b` == `NOT (a OR b)`  
  ![nor_example][def20]  
