...
- Example C Program  
![example_c_program](TODO)  

- From Program to Process 
![from_program_to_process](TODO)  
...
- MIPS byte/halfword load/store
  - String 처리가 common case
    ...
    ![byte_halfword_load_store](TODO)  
    - Zero extension (32 bits in `rt`)  
    ![byte_halfword_load_store_zero_extension](TODO)  
    - 오직 rightmost byte/halfword 저장  
    ![byte_halfword_store](TODO)  
...
- Loading a 32-bit Constant
  - 대부분의 Constants들은 작다.
    ...
    ![i_format_constant](TODO)  

  - 하지만 종종 32-bit constant가 필요할 때가 있다.  
  `0000 0000 0011 1101 0000 1001 0000 0000`  

  - 컴파일된 MIPS code  
  ![loading_32_bit_constant](TODO)  
