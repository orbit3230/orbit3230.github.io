...
excerpt: "Data Format, MIPS-32 ISA, MIPS Design Principles, MIPS Instructions, (Review+) Integers, Representing Instructions, Logical Operations, Review+: From Assembly to Machine Code, MIPS Control Flow Instructions, Procedure, Character Data, Byte/Halfword Operations, Constants, Addressing"
